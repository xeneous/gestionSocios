...
class ItemFacturacionPrevia {
  ...
  final double porcentajeDescuento; // 0 = sin descuento, 50 = 50%, 100 = bonificada
  ...
  bool get tieneDescuento => porcentajeDescuento > 0;
  bool get esBonificada => porcentajeDescuento >= 100;
}
