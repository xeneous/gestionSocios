-- ============================================================================
-- CUENTAS CORRIENTES - PARTE 2: Tablas Principales (Con dependencias)
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS cuentas_corrientes (
  ...
  -- Constraint: debe tener socio_id O profesional_id según entidad_id
  CONSTRAINT check_entidad_referencia CHECK (
