...
// import '../../features/comprobantes_prov/presentation/pages/pago_directo_page.dart'; // deshabilitado temporalmente
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      // Pago Directo deshabilitado temporalmente (en desarrollo)
      // GoRoute(
      //   path: '/pago-directo',
      //   name: 'pago-directo',
